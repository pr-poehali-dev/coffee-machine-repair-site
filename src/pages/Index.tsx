            ...
            {[
              {
                ...
                platform: "Авито",
                rating: 5,
                text: "Отличный мастер! Делонги починили за день, работает как новая. Рекомендую!",
                date: "2 дня назад",
              },
              {
                name: "Мария П.",
                ...
                rating: 5,
                text: "Быстро, качественно, недорого. Кофемашина Саеко снова радует нас вкусным кофе.",
                date: "1 неделю назад",
              },
              {
                name: "Дмитрий С.",
                ...
                rating: 5,
                text: "Профессиональный подход. Объяснили что сломалось, починили, дали гарантию.",
                date: "3 дня назад",
              },
              {
                name: "Елена В.",
                platform: "Авито",
                rating: 5,
                text: "Очень довольна сервисом. Юра - настоящий профессионал своего дела!",
                date: "5 дней назад",
              },
              {
                name: "Игорь Т.",
                platform: "Google Карты",
                rating: 5,
                text: "Кофемашина Бош работает отлично после ремонта. Спасибо за качественную работу!",
                date: "1 день назад",
              },
              {
                name: "Анна Л.",
                platform: "Яндекс Карты",
                rating: 5,
                text: "Адекватные цены, быстрая работа. Рекомендую всем, кто ценит качество!",
                date: "4 дня назад",
              },
            ].map((review, index) => (
              <Card
